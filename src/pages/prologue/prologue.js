              ...
              >
                <div className="image-container">
                  <div className="1">
                    ...
                    ></img>
                    <div style={text}>
                      However, some has recalled “the western sky”, hell in
                      Asian culture, which has a huge garden with every kind of
                      flowers bloomed together. And this, indeed, was a prelude
                      to the hell.
                    </div>
                  </div>
                </div>
                ...
                <div className="image-container">
                  <div className="3">
                    ...
                    <div style={text}>
                      ...
                      conventioned Paris Climate Agreement and has the “force”
                      to every countries.
                    </div>
                  </div>
                </div>
                ...
                <div className="image-container">
                  <div className="5">
                    ...
                    <div style={text}>
                      ...
                      fuels needed to produce electricity itself is a problem,
                      but the heating of electricity-using devices itself is
                      also causing a major problem in the climate crisis.
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="image-container">
                  <div className="6">
                    ...
                    ></img>
                    <div style={text}>
                      Second, total ban on meat-eating businesses. With
                      increased interest in human rights, animal rights, and the
                      climate crisis, people agreed that we must stop producing
                      and consuming animal meat. Therefore, the treaty has been
                      executed with the International Convention on Animal
                      Rights.
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="image-container">
                  <div className="7">
                    ...
                    ></img>
                    <div style={text}>
                      Third, complete replacement of fossil energy over a
                      decade. Fossil energy itself is running out, and the
                      seriousness of environmental pollution in their use has
                      long emerged. The world cannot delay the replacement of
                      fossil energy anymore.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="image-container">
                  <div className="8">
                    ...
                    <div style={text}>
                      ...
                      agreement. First, of course, there was no meat on the
                      table. With other changes, additional installations of
                      CCTVs have disappeared as they violate human rights but
                      consume a lot of standby power.
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="image-container">
                  <div className="9">
                    ...
                    ></img>
                    <div style={text}>
                      Then, in areas where power consumption could not be
                      reduced, CCTVs were removed. Accordingly, the slumming of
                      the poor area accelerated, and the types of crimes
                      diversified.
                    </div>
                  </div>
                </div>
                ...
                <div className="image-container">
                  <div className="10">
                    ...
                    <div style={text}>
                      ...
                      tracks the criminal and the crime. However, this AI had
                      one major flaw. It was a serious prejudice, such as
                      pointing out only white men as human beings. <br /> The AI
                      was not recognized by academia and Victor Frankenstein,
                      its developer, also abandoned further development.
                      However, a country trying to use this AI for actual
